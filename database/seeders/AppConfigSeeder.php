    ...
    public function run()
    {
        $config = [
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 11,
                'key' => 'meedu.payment.alipay-h5.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 101,
                'key' => 'meedu.payment.wechat-h5.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 103,
                'key' => 'meedu.payment.wechat-mini.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
                ...
                'field_type' => 'switch',
                'sort' => 104,
                'key' => 'meedu.payment.wechat-app.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
            ...
            [
                ...
                'field_type' => 'switch',
                'sort' => 301,
                'key' => 'meedu.payment.handPay-h5.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
                ...
                'field_type' => 'switch',
                'sort' => 302,
                'key' => 'meedu.payment.handPay-wechat.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
                ...
                'field_type' => 'switch',
                'sort' => 303,
                'key' => 'meedu.payment.handPay-wechat-mini.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
                ...
                'field_type' => 'switch',
                'sort' => 304,
                'key' => 'meedu.payment.handPay-app.enabled',
                'value' => 0,
            ],
            [
                'group' => '支付',
            ...
            [
                'group' => '会员',
                'name' => '短信登录手机号不存在是否创建新账号',
                'field_type' => 'switch',
                'sort' => 40,
                'default_value' => 0,
                'key' => 'meedu.member.is_create_account_on_sms_login',
                'value' => 0,
            ],
            [
                'group' => '会员',
